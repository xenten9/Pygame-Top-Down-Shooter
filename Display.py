...
def load_assets():
    ...
    assets["font"] = pygame.font.SysFont(pygame.font.get_default_font(), 30)
...
def draw_screen(screen, player, enemies, dead_enemies, tiles, assets):
    ...
    player.display_kills(screen, assets)
